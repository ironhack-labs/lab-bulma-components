...
const CoolButton = (props) => {
 ...
 const buttonProps = props.className ? [props.className] : [];
 console.log("Las propiedasdes del boton ==>", buttonProps)
 ...
 return (
   <div>
     <button className={"button " + buttonProps.join(' ')}>{props.children}</button>
   </div>
