      ...
      <div className="navbar-item">
        <div className="field is-grouped">
          <p className="control">
            ...
            <CoolButton btnArray={['isBig', 'isInfo']} className="my-class">Login</CoolButton>
          </p>
          <p className="control">
            ...
            <CoolButton btnArray={['isBig', 'isSuccess', 'isPrimary']} className="my-class">Signup</CoolButton>
          </p>
        </div>
      </div>
    </div>
