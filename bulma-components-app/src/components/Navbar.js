  ...
  <div id="navbarExampleTransparentExample" className="navbar-menu">
    ...
    <div className="navbar-end">
      <a className="navbar-item" href="#">
       <CoolButton className="is-success login-button is-rounded" name="Log In"></CoolButton>
      </a>
      <a className="navbar-item" href="#">
      <CoolButton  className="isSmall isDanger login-button" name="Sign In"></CoolButton>
      </a>
